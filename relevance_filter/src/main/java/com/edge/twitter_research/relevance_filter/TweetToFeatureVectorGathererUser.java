...
public class TweetToFeatureVectorGathererUser
    ...
    public void gather(KijiRowData input, GathererContext<LongWritable, Text> context)
        ...
        if (Math.random() < threshold){
            ...
            if (generatingTrainingSet){
                ...
                try{
                    tweetFeatureVector =
                            tweetFeatureVectorGenerator.getFeatureVector(tweet, "user",
                ...
                tweetFeatureVector = tweetFeatureVectorGenerator.getFeatureVector(tweet, "user");
            }
