...
public class TweetToFeatureVectorGathererTweet
    ...
    public void gather(KijiRowData input, GathererContext<LongWritable, Text> context)
        ...
        if (Math.random() < threshold){
            ...
            if (generatingTrainingSet){
                ...
                try{
                    tweetFeatureVector =
                        tweetFeatureVectorGenerator.getFeatureVector(tweet, "tweet",
                ...
                tweetFeatureVector = tweetFeatureVectorGenerator.getFeatureVector(tweet, "tweet");
            }
