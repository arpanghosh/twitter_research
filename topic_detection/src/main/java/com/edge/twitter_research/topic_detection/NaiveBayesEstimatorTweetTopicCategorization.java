...
public class NaiveBayesEstimatorTweetTopicCategorization {
    ...
    public static void main(String[] args){
        ...
        Logger logger = Logger.getLogger(NaiveBayesEstimatorTweetTopicCategorization.class);
            ...
            for (File dataSetName : dataFolder.listFiles()){
                ...
                */
                ...
                try{
                    ...
                    eval.crossValidateModel(naiveBayesEstimatorClassifier, vectorizedData, 5,
